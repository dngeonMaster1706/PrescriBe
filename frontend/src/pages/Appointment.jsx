    ...
    <div>
      ...
      <div className='flex flex-col sm:flex-row gap-4'>
        ...
        <div className='flex-1 border border-gray-400 rounded-lg p-8 py-8 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0'>
          ...
          <div>
            ...
            <p className='text-sm text-gray-500 maxt-w-[-700px] mt-1'>{docInfo.about}</p>
          </div>
      ...
      <div className='sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700'>
        ...
        <div className='flex items-center gap-3 w-full overflow-x-scroll mt-4'>
          ...
          <button className='bg-primary text-white text-sm font-light px-14 py-3 rounded-full mt-5'>Book Here</button>
